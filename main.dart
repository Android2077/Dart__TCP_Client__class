...
void main() async
{
  ...
  //Доступные методы:
  //set__Shared_Callback_for_ConnectionStatus
  //set__Shared_Callback_for_CloseSocket
  //set__Shared_Callback_for_Read

  //add__NewSocket
  //get__Socket_by_Name
  //Connect
  //send__Bytes_to_socket
  //set__ReadParamFlag_for_Socket
  //set__ReadUntill_Seperator_for_Socket
  //set__AccumulateBuffer_Size_for_Socket
  //close_Socket__Sync
  //destroy_Socket__Sync
  //close_AllSocket__Sync
  //destroy_AllSocket__Sync
  //get__Socket_Close_status
  ...
  void Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct? Socket_Struct__ref, String text_error) lambda_error_ = (TCP_Client__class TCP_Client__class__ref, Socket_Struct? Socket_Struct__ref, String text_error) async
  {
    ...
    //await TCP_Client__class__ref.destroy_Socket__Sync(Socket_Struct__ref, false);
  };
  ...
  //await TCP_Client_.close_Socket__Sync(Socket_Struct_ref_5, flush_flag, erase_socket_flag);

  //----------------------------------------------------------------------------11-close_Socket__Sync:End------------------------------------------------------------------------------------------------



  //-----------------------------------------------------------------------12-destroy_Socket__Sync:Begin------------------------------------------------------------------------------------------------
  ...
  //await TCP_Client_.destroy_Socket__Sync(Socket_Struct_ref_6, erase_socket_flag_1);
  //-----------------------------------------------------------------------12-destroy_Socket__Sync:End------------------------------------------------------------------------------------------------



  //-------------------------------------------------------------------------13-close_AllSocket__Sync:Begin------------------------------------------------------------------------------------------------
  ...
  //await TCP_Client_.close_AllSocket__Sync(flush_flag_1, erase_socket_flag_);

  //-------------------------------------------------------------------------13-close_AllSocket__Sync:End------------------------------------------------------------------------------------------------




  //----------------------------------------------------------------------14-destroy_AllSocket__Sync:Begin------------------------------------------------------------------------------------------------
  ...
  //await TCP_Client_.destroy_AllSocket__Sync(erase_socket_flag_2);

  print("List_Socket_Size:${TCP_Client_.get__Socket_List_Size()}");
  //----------------------------------------------------------------------14-destroy_AllSocket__Sync:End------------------------------------------------------------------------------------------------
