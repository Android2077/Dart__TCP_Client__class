...
class Socket_Struct
{
  ...
  Socket_Struct(String Socket_name_)
  {
  ...
  //----------------------------------------------Struct_for_Write:Begin------------------------------------------------------------
  late List<Function()> _Write__Tasks_waiting_for_Connection = [];         //Очередь задач ожидания соединения - на отправку данных в Сокет. То есть сюда будут помещатся задачи на отравку данных в Сокет, До тех пор пока на Сокете не будет установлено соединение.
  //----------------------------------------------Struct_for_Write:End--------------------------------------------------------------
  ...
  late Uint8List        _Read__ReadUntill_seperator;
  //``````````````````````````````````````````````
  
  //``````````````````````````````````````````````
  Uint8List__class _Read__AccumulateBuffer = new Uint8List__class();
  int _Read__Accumulate_size = 1024;   //по умолчанию.
  //``````````````````````````````````````````````
...
class TCP_Client__class
{

  //-------------------------------------------------------------------------------------------
  TCP_Client__class(Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct? Socket_Struct__ref, String text_error) lambda_error_)
  {
    _User_Shared_lambda_error = lambda_error_;
  }
  //-------------------------------------------------------------------------------------------
  ...
  //*****************************************************************Public:Begin******************************************************************************
   ...
   //-----------------------------------------------------Set_shared_Callback:Begin---------------------------------------------------------------

  void set__Shared_Callback_for_CloseSocket(Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref) User_lambda_for_CloseSocket_)
  {
    _User_Shared_lambda_for_CloseSocket = User_lambda_for_CloseSocket_;
  }

  void set__Shared_Callback_for_ConnectionStatus(Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct__ref, bool Connection_flag) User_lambda_for_ConnectionStatus_)
  {
    _User_Shared_lambda_for_ConnectionStatus = User_lambda_for_ConnectionStatus_;
  }

  void set__Shared_Callback_for_Read(Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct__ref, Uint8List data) User_lambda_for_Read_)
  {
    _User_Shared_lambda_for_Read = User_lambda_for_Read_;
  }

  //------------------------------------------------------Set_shared_Callback:End---------------------------------------------------------------


  //---------------------------------------------------------------------------------------------------------------------
  Socket_Struct add__NewSocket(String Socket_name)
  {

    //------------------------------------------------------------------
    _STD_LIST__Socket_Struct.push_back(new Socket_Struct(Socket_name));

    _UnorderedMap_SocketName[Socket_name] = _STD_LIST__Socket_Struct.last()!;    //Доавбляем связку в Хеш-таблицу.

    _STD_LIST__Socket_Struct.last()!.get__value()._socket_it = _STD_LIST__Socket_Struct.last()!;     //Добавим "итератор" на элемент "_STD_LIST__Socket_Struct" в стурктуру Сокета.
    //------------------------------------------------------------------

    return _STD_LIST__Socket_Struct.last()!.get__value();
  }

  Socket_Struct? get__Socket_by_Name(String Socket_name)
  {

    final STD_LIST_Iterator<Socket_Struct>? STD_LIST_Iterator_ = _UnorderedMap_SocketName[Socket_name];

    if (STD_LIST_Iterator_ != null)
    {
      return STD_LIST_Iterator_.get__value();
    }
    else
    {
      return null;
  ...
  bool get__Socket_Close_status(Socket_Struct Socket_Struct__ref)
  {
    return Socket_Struct__ref._socket_close;
  }
  //---------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Future<void> Connect(Socket_Struct Socket_Struct_, String Host, int port, Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref, bool connect_flag)? user_func_Connect, Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref, Uint8List data)? user_func_Read)async
  {

    //-------------------------------------------------------------------
    if(Socket_Struct_._socket_close == false)
    {
    ...
    {
      //Значит Соединение на Сокете - установлено:

      _connect(socket, Socket_Struct_, user_func_Connect, user_func_Read);

    }).catchError((e)
    {
      //Отлавливаем возможную ошибку от Connect:
  ...
  //---------------------------------------------------------------------------------------------------------------------
  void set__ReadParamFlag_for_Socket(Socket_Struct Socket_Struct_ref, read_flag ReadUntill_flag_)
  {
    Socket_Struct_ref._read_flag = ReadUntill_flag_;
  }

  void set__ReadUntill_Seperator_for_Socket(Socket_Struct Socket_Struct_ref, Uint8List Uint8List_Separator)
  {
    Socket_Struct_ref._Read__ReadUntill_seperator = Uint8List(Uint8List_Separator.length);   //Выделим память

    memcpy(Socket_Struct_ref._Read__ReadUntill_seperator, 0, Uint8List_Separator, 0, Uint8List_Separator.length);  //перекопируем Пользовательский разделитель в стурктуру сокета.
  }


  void set__AccumulateBuffer_Size_for_Socket(Socket_Struct Socket_Struct_ref, int size)
  {
    Socket_Struct_ref._Read__Accumulate_size = size;
  }
  //---------------------------------------------------------------------------------------------------------------------
  ...
  void send__Bytes_to_socket(Socket_Struct Socket_Struct__ref, Uint8List data, bool copy_data_flag)
  {
    ...
    {
      //Значит Пользователю нужно держать буффер "data" полностью рабочим и неизменяемым, до передачи данных. Но блять есть проблема, как узнать, что данные уже отправлены, и буффер можно переиспользовать. А хрен знает, я так и не понял.
    ...
    try
    {
      if (Socket_Struct__ref._connect_flag == false)
      {
        //Значит соединение по Сокету еще не установлено, значит занесем задачу в очередь ожидания установки соединения.

        //-----------------------------------------------------------------------------
        Socket_Struct__ref._Write__Tasks_waiting_for_Connection.add(()
        {
      ...
      {
        //Значит соединение по Сокету уже установлено.
  ...
  HashMap<String, STD_LIST_Iterator<Socket_Struct>> _UnorderedMap_SocketName = HashMap<String, STD_LIST_Iterator<Socket_Struct>>();
  //--------------------------------------------------------------------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------------------------------------------------------------------
  late Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct? Socket_Struct__ref, String text_error) _User_Shared_lambda_error;
  //-------------------------------------------------------------------------------------------------------------------------------


  //-------------------------------------------------------------------------------------------------------------------------------
  Function(TCP_Client__class TCP_Client__class_ref, Socket_Struct Socket_Struct_ref)? _User_Shared_lambda_for_CloseSocket;

  Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct__ref, bool Connection_flag)? _User_Shared_lambda_for_ConnectionStatus;

  Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct__ref, Uint8List data)? _User_Shared_lambda_for_Read;
  //-------------------------------------------------------------------------------------------------------------------------------
  ...
  void _connect(Socket socket, Socket_Struct Socket_Struct_, Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref, bool connect_flag)? user_func_Connect, Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref, Uint8List data)? user_func_Read)
  {

    //----------------------------------------------------------------------------------------
    Socket_Struct_._socket = socket;

    Socket_Struct_._connect_flag = true;
    Socket_Struct_._socket_close = false;

    if(_User_Shared_lambda_for_ConnectionStatus != null)
    {
      _User_Shared_lambda_for_ConnectionStatus!(this, Socket_Struct_, Socket_Struct_._connect_flag);
    }

    if(user_func_Connect != null)
    {
      user_func_Connect(this, Socket_Struct_, Socket_Struct_._connect_flag);
    }
    //---------------------------------------------------------------------------------------



    //----------------------------Проверяем очередь ожидания задач на отправку:Begin-----------------------------------------------------------
    if(Socket_Struct_._Write__Tasks_waiting_for_Connection.length > 0)
    {

      for(int i = 0; i < Socket_Struct_._Write__Tasks_waiting_for_Connection.length; i++)
      {
        Socket_Struct_._Write__Tasks_waiting_for_Connection[i]();    //Вызываем выполнение задачи.

      }

      Socket_Struct_._Write__Tasks_waiting_for_Connection.clear();
    }
    //----------------------------Проверяем очередь ожидания задач на отправку:End-----------------------------------------------------------




    //------------------------------Встаем на прослушку Сокета для Входящих данных:Begin---------------------------------------------------------
    Socket_Struct_._Read__StreamSubscription_for_Read = socket.listen((Uint8List Incoming_data)
    {
      //Если вызывается данный колбек, то значит пришла очередная порция Входящих данных "Incoming_data".

      _Read_choose_param(Socket_Struct_, Incoming_data, user_func_Read);    //Читаем Входяие данные.
    },
        onDone: ()async
        {
  ...
  void _Read_choose_param(Socket_Struct Socket_Struct_, Uint8List Incoming_data, Function(TCP_Client__class TCP_Client__class__ref, Socket_Struct Socket_Struct_ref, Uint8List data)? user_func_Read)
  {

    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if(Socket_Struct_._read_flag == read_flag.Original_chunk)
    {
      //-----------------------------------------------------
      if(_User_Shared_lambda_for_Read != null)
      {
        _User_Shared_lambda_for_Read!(this, Socket_Struct_, Incoming_data);    //Вызываем Пользовательский колбек.
      }

      if(user_func_Read != null)
      {
        user_func_Read(this, Socket_Struct_, Incoming_data);
      }
      //-----------------------------------------------------
    }
    else
    {
      if(Socket_Struct_._read_flag == read_flag.Read_untill)
      {
